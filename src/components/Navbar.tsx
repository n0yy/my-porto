...
export default function Navbar() {
  return (
    <div className="reference-nav-shell fixed top-4 z-50 md:top-6">
      <motion.nav
        initial={{ opacity: 0, y: -12 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.45, ease: [0.2, 0, 0, 1] }}
        className="reference-nav border border-[rgba(23,21,16,0.18)] bg-[#e9dfc7]/86 px-4 py-3 backdrop-blur-sm md:px-5"
      >
